...
def create_interactive_plot(
    ...
    **render_html_kwds:
    ...
    elif len(label_layers) == 1:
        # Retrieve the single label layer and its metadata
        labels = label_layers[0]
        
        # Construct the label dataframe directly from data_map_coords
        label_dataframe = pd.DataFrame(
            {
